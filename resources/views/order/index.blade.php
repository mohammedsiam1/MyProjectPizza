            ...
            <div class="col-md-12">
                ...
                <div class="card ">
                    <div class="card-header">order
                        <a style="float:right;" href="{{ route('index') }}"><button class="bnt btn-secondary btn-sm" style="margin-left: 5px;">View Pizza</button></a>
                        <a style="float:right;" href="{{ route('Pizza.index') }}"><button class="bnt btn-secondary btn-sm">Add new Pizza</button></a>

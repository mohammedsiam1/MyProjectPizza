                        ...
                        @if (Auth::check())
                            <form action="{{ route('order.store') }}" method="post">@csrf
                                <div class="form-group ">
                                    ...
                                    <p>Phone number: <input type="number"  min="111" class="form-control" name="phone" required></p>
            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <img src="{{asset('folderimge/'.$pizza ->image )  }}" class="img-thumbnail" style="height: 50%;width: 50%;" >
                        <p>
                        <h3>{{ $pizza->name }}</h3>
                        </p>
                        <p>
